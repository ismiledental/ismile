                ...
                <div className="sidebar-widget categories">
                  <div className="widget-content">
                    <ul className="services-categories">
                      ...
                      <li className="active">
                        <Link to="single-service.html">Dental Implants</Link>
                      </li>
                      <li>
                        <Link to="single-service.html"> Tooth Filling</Link>
                      </li>
                      <li>
                        <Link to="single-service.html">Dental X-ray</Link>
                      </li>
                      <li>
                        <Link to="single-service.html">Oral Surgery</Link>
                      </li>
                      <li>
                        <Link to="single-service.html">Veneer & Crown</Link>
                      </li>
                    </ul>
                  </div>
                </div>
